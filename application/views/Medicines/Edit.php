									...
									echo form_open_multipart(base_url("Medicines/Edit/{$Medicine->EntityNo}"),array('name' => 'NewMedicineForm','class' => 'form-horizontal', 'id' => 'NewMedicineForm'));
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'name' => 'EntityNo',
													'value' => set_value('EntityNo',$Medicine->EntityNo),
													'readonly' => 'readonly',
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'name' => 'Name',
													'value' => set_value('Name',$Medicine->Name),
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'name' => 'BatchNumber',
													'value' => set_value('BatchNumber',$Medicine->BatchNumber),
													'id' => 'BatchNumber',
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
		                                			'type' => 'text',
													'name' => 'Quantity',
													'value' => set_value('Quantity',$Medicine->Quantity),
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'value' => set_value('EntryDate',$Medicine->EntryDate),
													'name' => 'EntryDate',
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'value' => set_value('ProductionDate',$Medicine->ProductionDate),
													'name' => 'ProductionDate',
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'value' => set_value('ExpireDate',$Medicine->ExpireDate),
													'name' => 'ExpireDate',
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'name' => 'BuyingPrice',
													'value' => set_value('BuyingPrice',$Medicine->BuyingPrice),
		                                ...
		                                echo '<div class="form-group">';
		                                	...
		                                	echo '<div class="col-lg-5">';
		                                		$data= array(
													'type' => 'text',
													'value' => set_value('SellingPrice',$Medicine->SellingPrice),
													'name' => 'SellingPrice',
