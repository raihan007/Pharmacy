							...
							<section class="panel">
	                            ...
	                            <div class="panel-body">
		                            ...
		                            <div class="">
		                            	...
		                            	<a href="#postModal" data-toggle="modal" class="btn btn-sm btn-success" data-target="#postModal"> Edit</a>
		                            </div>
								</div>
	                        </section>
						</div>
                    ...
                    <div id="postModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                          	...
                          	<div class="">
                          		<?= anchor(base_url('Admin/UpdateEmployee/'.$employee->EntityNo)," Edit",array('class'=>"btn btn-sm btn-primary",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'data-original-title'=>"Edit"))
                          		?>
